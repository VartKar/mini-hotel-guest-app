...
const features = [
  "Персональные страницы для гостей",
  "Онлайн-заказ услуг и товаров",
  "QR-коды для каждой комнаты",
  "Панель управления для хоста",
...
const PricingSection = () => {
  return (
    <section id="pricing" className="py-20 md:py-28 bg-gradient-to-b from-muted/30 via-primary/5 to-background">
      <div className="container max-w-6xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <Badge className="mb-6 px-4 py-2 text-sm font-medium bg-gradient-to-r from-primary to-accent text-white border-0">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Дешевле, чем
            <span className="text-primary"> одна комиссия OTA</span>
          </h2>
          ...
          <div className="relative">
            ...
            <div className="relative bg-card rounded-3xl border-2 border-primary/20 shadow-2xl p-8 md:p-12">
              <div className="mb-8">
                ...
                <span className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mx-3">10 000</span>
              ...
              <p className="text-sm text-muted-foreground mt-6">
                Настройка за 15 минут • Отмена в любой момент
              </p>
            </div>
          </div>

          <p className="text-sm text-muted-foreground mt-8">
            Есть вопросы? <a href="mailto:hello@rubikinn.app" className="text-primary hover:underline font-medium">Напишите нам</a> — ответим за 5 минут
          </p>
        </div>
      </div>
    </section>

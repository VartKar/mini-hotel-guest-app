...
const Index = () => {
  return <div className="flex flex-col items-center">
      <div className="w-full max-w-md">
        <div className="py-8">
          <h1 className="font-light mb-3 text-center text-2xl">Добро пожаловать, Иван</h1>
        ...
        <div className="grid grid-cols-2 gap-4">
          {menuItems.map(item => <Link key={item.name} to={item.path} className="flex flex-col items-center justify-center bg-white rounded-lg p-6 shadow-sm transition-all hover:shadow-md">
